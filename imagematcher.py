...
def drawMatches(img1, kp1, img2, kp2, matches):
    """
    implementation of drawmatches borrowed shamelessly from stackexchange user
    rayryengllll (https://stackoverflow.com/questions/20259025/module-object-
...
def matcher(image1, image2, match_alg="flann", output_location=None, band=1):
    ...
    try:
        qext, trext = gdal_intersect_reader(gdalquerybil, gdaltrainbil)
